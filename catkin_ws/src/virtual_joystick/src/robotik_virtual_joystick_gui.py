...
def prepare_dpad():
    ...
    dpad = pygame.image.load(file_dir + "../images/robotik-pad.png")
    dpad = pygame.transform.scale(dpad, (screen_size, screen_size))
    dpad_pressed = pygame.image.load(file_dir + "../images/robotik-pad-pressed.png")
...
if __name__ == '__main__':
    ...
    file_dir = os.path.dirname(__file__)
    file_dir = (file_dir + "/") if  (file_dir) else ""
    logo = pygame.image.load(file_dir + "../images/robotik_logo.png")
    ...
    # prepare ROS node
    rospy.init_node('virtual_joystick',anonymous=False)
